...
_createRandomVehicle =
{
	...
	switch (true) do
	{
		...
		case (_num < 85): { _vehicleType = lightMilitaryVehicles call BIS_fnc_selectRandom };
...
diag_log format["WASTELAND - Vehicle spawning completed - %1 Vehicles Spawned on Zargabad",_counter];