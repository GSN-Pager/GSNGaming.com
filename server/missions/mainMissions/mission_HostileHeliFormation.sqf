...
if (A3W_missionsDifficulty == 1) then {
	_heli1 = ["O_Heli_Attack_02_black_F","I_Heli_light_03_F","B_Heli_Light_01_armed_F"] call BIS_fnc_selectRandom;
	_heli2 = ["O_Heli_Attack_02_black_F","I_Heli_light_03_F","B_Heli_Light_01_armed_F"] call BIS_fnc_selectRandom;
	_heli3 = ["O_Heli_Attack_02_black_F","I_Heli_light_03_F","B_Heli_Light_01_armed_F"] call BIS_fnc_selectRandom;
} else {
	_heli1 = ["O_Heli_Light_02_F","I_Heli_light_03_F","B_Heli_Light_01_armed_F"] call BIS_fnc_selectRandom;
	_heli2 = ["O_Heli_Light_02_F","I_Heli_light_03_F","B_Heli_Light_01_armed_F"] call BIS_fnc_selectRandom;
	_heli3 = ["O_Heli_Light_02_F","I_Heli_light_03_F","B_Heli_Light_01_armed_F"] call BIS_fnc_selectRandom;
};
...
_vehicles = [];
_vehicles set [0, [_heli1, [2925.025, 0.025], 20, _grouphf] call _createVehicle];  // static value update when porting to different maps
_vehicles set [1, [_heli2, [2960.025, 0.050], 171, _grouphf] call _createVehicle];
_vehicles set [2, [_heli3, [3020.025, 0.000], 222, _grouphf] call _createVehicle];
