...
// Sniper
_man8 = _group createUnit ["C_man_polo_3_F", [_pos select 0, (_pos select 1) - 40, 0], [], 1, "Form"];
removeAllAssignedItems _man8;
_man8 addUniform "U_B_GhillieSuit";
_man8 addVest "V_PlateCarrierGL_rgr";
_man8 addMagazine "20Rnd_762x51_Mag";
_man8 addWeapon "srifle_EBR_SOS_F";
_man8 addMagazine "20Rnd_762x51_Mag";
_man8 addMagazine "20Rnd_762x51_Mag";

// Anti Tank
_man9 = _group createUnit ["C_man_polo_3_F", [_pos select 0, (_pos select 1) - 40, 0], [], 1, "Form"];
removeAllAssignedItems _man9;
_man9 addUniform "U_B_CombatUniform_mcam_tshirt";
_man9 addVest "V_PlateCarrierGL_rgr";
_man9 addBackpack "B_Carryall_oucamo";
_man9 addMagazine "20Rnd_762x51_Mag";
_man9 addWeapon "srifle_EBR_ACO_F";
_man9 addMagazine "20Rnd_762x51_Mag";
_man9 addMagazine "20Rnd_762x51_Mag";
_man9 addMagazine "Titan_AT";
_man9 addWeapon "launch_Titan_short_F";
_man9 addMagazine "Titan_AT";
_man9 addMagazine "Titan_AT";
...
_man10 addVest "V_PlateCarrierGL_rgr";
_man10 addBackpack "B_Carryall_oucamo";
_man10 addMagazine "20Rnd_762x51_Mag";
_man10 addWeapon "srifle_EBR_ACO_F";
_man10 addMagazine "20Rnd_762x51_Mag";
_man10 addMagazine "20Rnd_762x51_Mag";
_man10 addMagazine "Titan_AA";
_man10 addWeapon "launch_Titan_F";
_man10 addMagazine "Titan_AA";
_man10 addMagazine "Titan_AA";
