...
_man5 addUniform "U_B_GhillieSuit";
...
// Anti Tank
_man6 = _group createUnit ["C_man_polo_3_F", [_pos select 0, (_pos select 1) - 40, 0], [], 1, "Form"];
removeAllAssignedItems _man6;
_man6 addUniform "U_B_CombatUniform_mcam_tshirt";
_man6 addVest "V_PlateCarrierGL_rgr";
_man6 addBackpack "B_Carryall_oucamo";
_man6 addMagazine "20Rnd_762x51_Mag";
_man6 addWeapon "srifle_EBR_ACO_F";
_man6 addMagazine "20Rnd_762x51_Mag";
_man6 addMagazine "20Rnd_762x51_Mag";
_man6 addMagazine "Titan_AT";
_man6 addWeapon "launch_Titan_short_F";
_man6 addMagazine "Titan_AT";
_man6 addMagazine "Titan_AT";
...
_man7 addVest "V_PlateCarrierGL_rgr";
_man7 addBackpack "B_Carryall_oucamo";
_man7 addMagazine "20Rnd_762x51_Mag";
_man7 addWeapon "srifle_EBR_ACO_F";
_man7 addMagazine "20Rnd_762x51_Mag";
_man7 addMagazine "20Rnd_762x51_Mag";
_man7 addMagazine "Titan_AA";
_man7 addWeapon "launch_Titan_F";
_man7 addMagazine "Titan_AA";
_man7 addMagazine "Titan_AA";
