...
_oddfuelcan = 55;				//Chance of a spawned fuelcan to be full instead of empty
...
_interval = 3600;				//Time (in sec.) to pass before a city spawns new loot (5400 - 1,5 hr)
...
//-------------------------------------------------------------------------------------
// Old ArmA 2 Building Loot Script
