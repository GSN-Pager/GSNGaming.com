...
"v1",
"
<br/> [Pilot] - GSNGaming.com Alpha Version of our ArmA 3 Zargabad Wasteland based off of Team Wasteland Altis 0.9f.
<br/> [Gun Store] - Where you can get a wide variety of Weapons, Ammo and Equipment.
<br/> [General Store] - Has Food, Water, Jerry Cans, Spawn Beacons, and Camo Netting.
<br/> [Vehicle Store] - Where you can get almost any Vehicle for a price.
<br/> [Vehicle Service] - Is where you can pull up and Refuel, Repair, and Rearm your vehicle.
<br/> [Heli Service] - Same as Vehicle Service but for Heli. You must land on the Heli Pad.
<br/> [First-Aid] - If your not a medic and need healed you can go in this building and get Healed.
<br/> [Money Missions] - Will be turned OFF till they are fixed.
<br/> [Added] - FAR's Revive System and it's set for Medic's only can revive and they have 2 minutes to get to you before you bleed out.
<br/> [For Now] - MBT's do not spawn and will NOT be in Missions.
<br/> [HMG's & GMG's] - Are turned off as a Spawning Vehicle they will only be in Missions.
<br/> [Planes] - Are turned off we feel they are to over powered.
<br/> [Boats] - Are not needed since Zargabad doesn't have much water.
<br/> [Divers] - Were changed to Recon since Zargabad doesn't have much water.
<br/> [Errors] - Are likely and will be fixed when found in our next patch or update.
<br/> [Report] - Errors that you find you can report them to our Forums @ GSNGaming.com.
<br/> [Modifier] - GSN Pager This is the GSNGaming.com Version of the Team Wasteland Mod. Their Code Our Tweaking.
"
]
];
